...
const icons = {
    dashboard: (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-[15px] h-[15px] flex-shrink-0 opacity-70 transition-opacity duration-200 group-hover:opacity-100">
    ...
    leaf: (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white fill-none stroke-current stroke-[1.8] [stroke-linecap:round] [stroke-linejoin:round]">
...
const links = [
    ...
    { label: "Weekly Meal Plan",      path: "/profile",       icon: icons.profile,     end: false },
];
        ...
        <>
            ...
            >
                <div className="max-w-[1280px] mx-auto px-6 h-full flex items-center gap-10">
                    ...
                    {/* Brand */}
                    <NavLink to="/" className="flex items-center gap-2 no-underline flex-shrink-0 group" aria-label="NutriAI Home">
                        <span
                    ...
                    {showFullNav && (
                        ...
                        >
                            <span className={`block w-5 h-0.5 rounded-sm bg-[#57534e] transition-transform duration-300 origin-center ${open ? "translate-y-[7px] rotate-45" : ""}`} />
                            <span className={`block h-0.5 rounded-sm bg-[#57534e] transition-all duration-200 origin-center ${open ? "w-0 opacity-0" : "w-5 opacity-100"}`} />
                            <span className={`block w-5 h-0.5 rounded-sm bg-[#57534e] transition-transform duration-300 origin-center ${open ? "-translate-y-[7px] -rotate-45" : ""}`} />
                        </button>
                    )}
                </div>
